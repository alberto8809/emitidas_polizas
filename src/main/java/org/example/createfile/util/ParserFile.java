...
public class ParserFile {
    private static final String PATH = "/Users/marioalberto/Desktop/polizas/";

    public ParserFile() {
    }

    public static PolicyObjFile getParse(String FileName) {
...
//                Element ime = (Element) impe.item(impe.getLength() - 1);
                ...
                return new PolicyObjFile(values, FileName, companyName, cli, currentDate.substring(0, 10), typeOf, typeOfPayment);
